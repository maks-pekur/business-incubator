			...
			<section className="sticky -top-[50vh] bg-black pb-10">
				<div className="bg-white p-20 rounded-3xl">
					...
					<p>
						...
						(przeglądarki internetowej) np.: – w przeglądarce Internet Explorer
						– w przeglądarce Mozilla Firefox – w przeglądarce Chrome – w
						przeglądarce Safari – w przeglądarce Opera Operator Serwisu
						...
						operatorem partnerów. KONTAKT Z ADMINISTRATOREM Administrator
